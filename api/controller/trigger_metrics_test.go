...
func TestGetTriggerMetrics(t *testing.T) {
	...
	Convey("Has metrics", t, func() {
		...
		So(err, ShouldBeNil)
		So(*triggerMetrics, ShouldResemble, dto.TriggerMetrics{Main: map[string][]*moira.MetricValue{metric: {{Value: 0, Timestamp: 17}, {Value: 1, Timestamp: 27}, {Value: 2, Timestamp: 37}, {Value: 3, Timestamp: 47}, {Value: 4, Timestamp: 57}}}, Additional: make(map[string][]*moira.MetricValue, 0)})
	})
